    ...
    <div class="flex items-center">
        ...
        <div class="flex items-center md:order-1">
                    ...
                    <div class="absolute cartDropDown dropDown overflow-y-scroll no-scrollbar" id="cartBody">
                        <div class="h-[50vh] overflow-y-scroll no-scrollbar">
                            ...
                            <div class="flex flex-col w-full px-[15px] py-[5px]">
                                ...
                                <hr>
                                <!-- body -->
                                <div class=" rounded-md mt-4 text-xs p-4 bg-white">
                                    <ul>
            ...
            <div class="flex items-center mb-[6px] ">
                ...
                <!-- Dropdown menu -->
                <div class="z-50 w-[215px] absolute duration-300  right-0 opacity-0 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600"
                    id="user-dropdown">
                    <div class="px-4 py-3">
                        <span class="block text-sm font-semibold text-gray-900 dark:text-white">Shuvro</span>
                        <span
