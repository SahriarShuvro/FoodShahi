let singInUpModal = document.getElementById("singInUpModal");

singInUpModal.innerHTML = `        <!-- Sing In modal -->
<div id="authentication-modal" tabindex="-1" aria-hidden="true"
    class="fixed top-0 SingUpModal left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" action="#">
                    ...
                    <div class="flex justify-between remember">
                        ...
                        <a href="forgotPassword.html" class="text-sm text-orange-700 hover:underline dark:text-orange-500">Lost
                            Password?</a>
                    </div>
                    <button type="submit"
...
<!-- Order Progress  -->
<a href="orderTrack.html" class="w-full fixed left-0 z-30 bottom-1">
...
<div class="bg-modal fixed bg-gray-300 top-[50%] left-[50%] z-50 flex justify-center items-center overflow-y-scroll no-scrollbar duration-200 w-0 h-0"
    id="modal">
    <div class="absolute bg-white rounded-md my-80  w-[90%] lg:w-[40%]  overflow-y-scroll no-scrollbar">
                ...
                <div class=" text-xs px-6 py-3">
                    <div class=" deliveryAreaInput">
                        ...
                        <div class="flex justify-between mt-3 ">
                            <input type="text"
                                class="inputsShadow outline-none px-4 py-2  border border-gray-300 rounded-bl-md rounded-tl-md w-[95%]"
                    ...
                    <div class="compleatAddressinput flex flex-col justify-between mt-3 w-full">
                        ...
                        <input type="text"
                            class="inputsShadow outline-none px-4 py-2 mt-3 border border-gray-300 rounded w-full"
        ...
        <div class="flex justify-between items-center px-6 py-3">
            ...
            <button type="button" onclick="hideModal()"
                class="w-[48%] border border-green-600 text-white bg-green-600 rounded-lg py-2 duration-300 hover:bg-white hover:text-green-600 ">SUBMIT</button>
        </div>
    </div>
</div>
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" action="#">
                    ...
                    <button type="submit"
                        class="w-full text-white bg-orange-500 hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-orange-500 dark:hover:bg-orange-500 dark:focus:ring-orange-600">Verify</button>
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="" action="#">
                    ...
                    <button type="submit"
                        class="mt-4 w-full text-white bg-orange-500 hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-orange-500 dark:hover:bg-orange-500 dark:focus:ring-orange-600">Okey</button>
        ...
        <div class="relative bg-white rounded-lg shadow border-2 border-success dark:bg-gray-700">
            ...
            <div class="p-6 text-center  ">
                ...
                <button data-modal-hide="orderSuccess" type="button"
                    class="text-white bg-success hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-600 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                    Okey
                </button>
            </div>
        </div>
